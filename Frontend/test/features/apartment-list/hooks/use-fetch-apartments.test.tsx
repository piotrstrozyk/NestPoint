...
describe('useFetchApartments', () => {
  ...
  it('fetches apartments for authenticated user', async () => {
    getMock.mockResolvedValueOnce({ data: apartments });
    const { result } = renderHook(() => useFetchApartments(), {
  ...
  it('fetches apartments for unauthenticated user (no token)', async () => {

...
NestPoint provides a robust backend for managing rental properties, owners, tenants, and rental agreements. The system supports advanced searching and filtering capabilities to efficiently find available properties based on multiple criteria, as well as an advanced map component.

Detailed running instructions are contained in README files for each service (Frontend and Backend)
...
![Alt text](./Frontend/images/map.png "Satellite map")
...
![Alt text](./Frontend/images/address.png "Address map")
...
![Alt text](./Frontend/images/auction.png "Auction window")
...
![Alt text](./Frontend/images/chat.png "Chat")
